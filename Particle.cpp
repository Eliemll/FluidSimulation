...
void Particle::updatePosition(const FluidSimulation fluidSimulation, sf::Vector2f samplePoint, float SmoothingRadius, float dt, float Damping)
{
    // Update de la vitesse
    m_velocity += PressureForce::CalculateGradient(fluidSimulation, samplePoint, SmoothingRadius);
